...
spacex_df = pd.read_csv("Interactive Visual Analytics/Ploty Dash/spacex_launch_dash.csv")
...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        #Pie chart showing total success launches for all sites
        fig = px.pie(
            spacex_df,
            values='class', #'class' is 1 for success, 0 for failure
            names='Launch Site',
